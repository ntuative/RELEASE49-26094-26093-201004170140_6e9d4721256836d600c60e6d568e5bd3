package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_549:Number = 64;
      
      public static const const_967:Number = 32;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_81 = new Vector3d();
         var_1045 = new Vector3d();
         var_1547 = 1;
         var_1545 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1546 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_425 != param1 * var_1546)
         {
            var_425 = param1 * var_1546;
            ++var_77;
         }
      }
      ...
      {
         if(var_427 != param1 * var_1547)
         {
            var_427 = param1 * var_1547;
            ++var_77;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_428 != null)
         {
            ...
            var_428.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_428.add(_loc3_,_loc4_);
            ++var_77;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1045.assign(_loc22_);
         }
         else
         {
            var_1045.assign(_loc17_);
         }
         ++var_77;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_426;
         _loc2_.z *= var_425;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1045);
         if(_loc3_ < var_2362 || _loc3_ > var_2361)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_426;
            _loc2_.z *= var_425;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1045);
         }
      ...
      {
         return new Vector3d(0 * var_427,0 * var_426,0 * var_425);
      }
      ...
      {
         return scale == const_549;
      }
      
      public function get scale() : Number
      {
         return var_190 / Math.sqrt(0.5);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_428 != null)
         {
            ...
            return var_428.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_190;
         var _loc6_:Number = -param1.y / var_190;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_82,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_427,0 * var_426,0 * var_425);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_81;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_427,param2.y * var_426,param2.z * var_425);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_427,param3.y * var_426,param3.z * var_425);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_427,param4.y * var_426,param4.z * var_425);
