package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private static var var_1146:int = 0;
      ...
      private var var_393:IRoomObjectEventHandler;
      
      private var var_1449:Vector3d;
      
      private var _instanceId:int = 0;
      
      private var _id:int;
      
      private var var_1450:Vector3d;
      ...
      {
         var_1450.assign(var_227);
         return var_1450;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_474.length)
         {
      ...
      public function setEventHandler(param1:IRoomObjectEventHandler) : void
      {
         ...
         var _loc2_:IRoomObjectEventHandler = var_393;
         if(_loc2_ != null)
         {
            var_393 = null;
            _loc2_.object = null;
      ...
      {
         if(param1 >= 0 && param1 < var_474.length)
         {
