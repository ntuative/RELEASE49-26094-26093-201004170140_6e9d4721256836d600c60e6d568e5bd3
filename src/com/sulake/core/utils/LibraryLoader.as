package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1409:int = 5;
      ...
      protected var var_287:URLRequest;
      ...
      protected function prepareLibrary() : void
      {
         ...
         if(var_370 == null)
         {
            failure("Failed to find resource class \"" + _name + "\" in library " + var_287.url + "!");
            return;
         }
         try
         {
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_953 > 0)
            {
               var_14.close();
               var_14.unload();
               addRequestCounterToUrlRequest(var_287,const_1409 - var_953);
               var_14.load(var_287,var_15);
               --var_953;
               return true;
            }
