package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_542:Array;
      
      private var var_642:uint = 0;
      
      protected var var_373:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_30 = new Array();
         var_542 = new Array();
         var_1112 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_373 = new AssetLibrary("lib-" + var_642++);
         var_30.push(var_373);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_373.createAsset(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_373.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_542.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      {
         return var_373.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_373.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return var_373.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_373.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < var_542.length)
            {
               _loc3_ = var_542[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_542.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return var_373.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_373.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_373.loadFromArchive(param1,param2);
      }
