package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_752:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1413 = new Dictionary();
         var_1677 = new Dictionary();
         TypeCodeTable.fillTables(var_1413,var_1677);
         var_1140 = new Dictionary();
         var_1676 = new Dictionary();
         StateCodeTable.fillTables(var_1140,var_1676);
         ...
         {
            var_379 = new Array();
            var_379.push(WindowState.const_64);
            var_379.push(WindowState.const_71);
            var_379.push(WindowState.const_94);
            var_379.push(WindowState.WINDOW_STATE_SELECTED);
            var_379.push(WindowState.const_80);
            var_379.push(WindowState.const_78);
            var_379.push(WindowState.const_99);
            var_379.push(WindowState.const_88);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1140)
         {
            _loc3_.push(var_1140[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  _loc20_.background = !!_loc7_.@background[0] ? _loc7_.@background[0] == "ICatalogNavigator" : false;
                  ...
                  addSkinRenderer(var_1413[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_649[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_649[param1] = new Array(SkinContainer.const_752);
         }
         var_649[param1][param2] = param3;
         if(true)
         {
            var_650[param1] = new Array(SkinContainer.const_752);
         }
         var_650[param1][param2] = param4;
      }
