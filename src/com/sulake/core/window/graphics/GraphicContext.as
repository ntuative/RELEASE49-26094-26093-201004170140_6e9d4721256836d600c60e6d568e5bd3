package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1018:uint = 256;
      ...
      public static const const_1503:uint = 128;
      
      public static const const_1586:uint = 64;
      
      public static const const_617:uint = 4;
      
      public static const const_1335:uint = 0;
      
      public static const const_1295:uint = 16;
      
      public static const const_546:uint = 1;
      
      public static const const_1279:uint = 8;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1279:
               ...
               break;
            case GraphicContext.const_1295:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_617:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1018:
               break;
            case GraphicContext.const_1335:
               break;
            default:
         ...
         if(var_635)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1610,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1610,16777215);
                  }
                  var_380 += bitmap.width * bitmap.height * 4;
               }
