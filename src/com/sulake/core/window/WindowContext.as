package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      private var var_669:WindowController;
      
      private var var_743:Date;
      
      protected var var_2279:IWindowParser;
      
      protected var var_943:Error;
      
      protected var var_2278:IInternalWindowServices;
      
      protected var var_93:WindowController;
      
      protected var var_1384:int = -1;
      
      protected var var_87:IDesktopWindow;
      
      private var var_1454:Boolean = false;
      
      protected var var_2368:Boolean = true;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_323 = param5;
         var_2278 = new InternalWindowServices(this,param5);
         var_2277 = param3;
         var_2279 = new WindowParser(this);
         var_743 = new Date();
         if(var_984 == null)
         {
            var_984 = new Factory();
      ...
      public function destroy(param1:IWindow) : Boolean
      {
         ...
         if(param1.state != WindowState.const_467)
         {
            param1.destroy();
         }
         return true;
      ...
      public function create(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:Rectangle, param7:Function, param8:IWindow, param9:uint, param10:Array = null, param11:Array = null) : IWindow
      {
         ...
         if(_loc12_ == null)
         {
            handleError(WindowContext.const_1147,new Error("Failed to solve implementation for window \"" + param1 + "\"!"));
            return null;
         }
         if(param8 == null)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc2_.stageX != var_568.x || _loc2_.stageY != var_568.y)
            {
               ...
               _loc5_ = new Array();
               var_87.groupChildrenUnderPoint(var_568,_loc5_);
            }
               ...
               if(_loc4_ != null && _loc4_.visible)
               {
                  ...
                  else if(_loc2_.type == MouseEvent.MOUSE_UP || _loc2_.type == MouseEvent.CLICK)
                  {
                     if(var_93 && true)
                     {
                        if(var_340 != null)
                        {
                           var_340.mouseEventReceived(_loc2_.type,var_93);
                        }
                     }
                  }
                  if(_loc2_.altKey)
      ...
      public function getMouseCursor() : IMouseCursor
      {
         if(var_1608 == null)
         {
            var_1608 = new MouseCursorControl(var_323);
         }
         return var_1608;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_369))
         {
