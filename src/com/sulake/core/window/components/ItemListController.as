package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1034:String = "scale_to_fit_items";
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1408:Boolean = true;
      ...
      protected var var_770:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_88 = 0;
         var_66 = 0;
         _horizontal = param2 == WindowType.const_292;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_161 = var_636 || !testParamFlag(WindowParam.const_34);
         _container = var_15.create("_CONTAINER","",WindowType.const_285,WindowStyle.const_337,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_240,containerEventHandler);
         _container.addEventListener(WindowEvent.const_483,containerEventHandler);
      ...
      {
         return new Rectangle(var_545 * maxScrollH,var_547 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_240,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_483,containerEventHandler);
         super.dispose();
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_545 = param1;
            _container.x = -var_545 * maxScrollH;
            var_15.invalidate(_container,visibleRegion,WindowRedrawFlag.const_76);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1033,_spacing,PropertyStruct.const_63,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1032,var_770,PropertyStruct.const_61,var_770 != const_1408));
         _loc1_.push(new PropertyStruct(const_1034,var_546,PropertyStruct.const_61,var_546 != const_1407));
         _loc1_.push(new PropertyStruct(const_1035,var_1117,PropertyStruct.const_61,var_1117 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1035:
                  ...
                  break;
               case const_1032:
                  var_770 = _loc2_.value as Boolean;
                  break;
            }
         }
