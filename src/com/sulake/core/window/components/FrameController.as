package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1069:String = "_HEADER";
      ...
      private static const const_1070:String = "_CONTENT";
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_759,_loc3_.left,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_761,_loc3_.top,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_762,0 - _loc3_.right,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_760,0 - _loc3_.bottom,PropertyStruct.const_63,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1205 == null)
         {
            var_1205 = findChildByTag(const_1069) as IHeaderWindow;
            if(!var_1205)
            {
      ...
      public function get content() : IWindowContainer
      {
         if(var_19 == null)
         {
            var_19 = findChildByTag(const_1070) as IWindowContainer;
            if(!var_19)
            {
