package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      public function get container() : IWindowContainer
      {
         if(var_1612 == null)
         {
            var_1612 = findChildByTag(TabContextController.const_1092) as IWindowContainer;
         }
         return var_1612;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_949 == null)
         {
            var_949 = findChildByTag(TabContextController.const_1091) as ITabSelectorWindow;
            if(var_949 != null)
            {
      ...
      {
         return !!var_922 ? selector.iterator : null;
      }
