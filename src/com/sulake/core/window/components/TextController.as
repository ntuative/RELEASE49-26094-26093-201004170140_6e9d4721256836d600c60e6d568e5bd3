package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_771:Boolean = false;
      ...
      {
         return new Rectangle(var_640 * maxScrollH,var_376 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_771)
         {
            context.removeLocalizationListener(var_327,this);
         }
         if(var_67 != null)
         {
            var_67.dispose();
      ...
      public function set text(param1:String) : void
      {
         ...
         var_327 = param1;
         if(var_327.charAt(0) == "$" && var_327.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_327.slice(2,var_327.indexOf("}")),this);
            var_771 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_822,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_411,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_411,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_653,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_653,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_653,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
