   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_341)
         {
            ...
            if(var_341)
            {
               var_341.addEventListener(WindowEvent.const_269,scrollBarEventProc);
               var_341.addEventListener(WindowEvent.const_196,scrollBarEventProc);
            }
         }
         return var_341;
      }
      ...
      override public function dispose() : void
      {
         if(var_341)
         {
            var_341.removeEventListener(WindowEvent.const_269,scrollBarEventProc);
            var_341.removeEventListener(WindowEvent.const_196,scrollBarEventProc);
            var_341 = null;
         }
         if(var_837)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_837)
         {
            var_837 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_837;
      }
