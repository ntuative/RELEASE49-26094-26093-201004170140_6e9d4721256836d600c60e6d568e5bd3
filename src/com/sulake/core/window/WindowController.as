package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_445 = _loc13_.blend;
            var_544 = _loc13_.treshold;
            if(var_636 != _loc13_.background)
            {
         ...
         if(param7 != null)
         {
            ...
            if(var_16)
            {
               var_15.invalidate(this,var_7,WindowRedrawFlag.const_76);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_111,WindowParam.const_138);
         var _loc2_:* = !testParamFlag(WindowParam.const_117,WindowParam.const_148);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
      ...
      {
         var_636 = param1;
         var_543 = !!var_636 ? uint(var_543 | var_1390) : uint(var_543 & 16777215);
      ...
      {
         var_544 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2201 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_881:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1299:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1383:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_630:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_537:
               _loc2_ = "null";
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_546,var_7);
            var_16.visible = var_365;
         }
         return var_16;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1030;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_445 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_15.invalidate(this,var_7,WindowRedrawFlag.const_938);
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_544);
      }
      
      public function set color(param1:uint) : void
      {
         var_1390 = param1 & 4278190080;
         var_543 = !!var_636 ? uint(param1) : uint(param1 & 16777215);
         var_15.invalidate(this,var_7,WindowRedrawFlag.const_76);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_705))
         {
            ...
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  if(testParamFlag(WindowParam.const_342))
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_214))
                        {
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_268))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_168:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_389,this,null));
                     if(testParamFlag(WindowParam.const_158,WindowParam.const_138))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_160,WindowParam.const_148))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                     {
                        ...
                        _param = _loc8_;
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_274,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_430:
                  var_15.invalidate(this,var_7.union(var_55),WindowRedrawFlag.const_471);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_962,this,null));
                     if(var_8 != null)
                     {
               ...
               case WindowNotifyEvent.const_282:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_519,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_212,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_357:
                  var_15.invalidate(this,var_7,WindowRedrawFlag.const_850);
                  break;
               case WindowNotifyEvent.const_437:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_425:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_15.invalidate(this,var_7,WindowRedrawFlag.const_471);
                     }
                  }
                  else if(_param & 0)
                  {
      ...
      {
         return var_641 != null ? var_641 : (var_8 != null ? var_8.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_544);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_670,this,param1));
         return param1;
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_910,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_620,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1347,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_64,true);
         _loc1_.type = WindowNotifyEvent.const_1293;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_161 && var_544 > 0)
         {
            if(!testParamFlag(WindowParam.const_34))
            {
               if(param1.x <= var_7.width && param1.y <= var_7.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1577,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1577,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_15.invalidate(this,param1,WindowRedrawFlag.const_76);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               ...
               var_55.width = var_7.width;
               var_55.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_433,this,var_8));
            }
            else
            {
               var_314.x = 0;
               ...
               var_314.width = 0;
               var_314.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_997,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,_param,var_15,var_7,null,var_641,properties,var_637.concat(),_id) as WindowController;
         ...
         _loc2_.var_1390 = var_1390;
         _loc2_.var_1116 = var_1116;
         ...
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_327;
         _loc2_.background = var_636;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_421;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_32 == WindowState.const_467)
         {
            return true;
         }
         var_32 = WindowState.const_467;
