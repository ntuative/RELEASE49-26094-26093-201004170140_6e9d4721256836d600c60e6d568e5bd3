package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_870:ConversationsTabView;
      
      private var _disposed:Boolean = false;
      
      private var var_136:HabboMessenger;
      
      private var var_1281:ConversationView;
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.var_1281.afterResize();
         this.var_870.refresh();
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_665.text = "";
         var_136.conversations.addMessageAndUpdateView(new Message(Message.const_716,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      public function openMessenger() : void
      {
         ...
         if(var_13 == null)
         {
            prepareContent();
            refresh(true);
            var_136.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.MESSENGER,var_13));
         }
         else
         {
            refresh(true);
      ...
      {
         return this.var_870 == null ? 7 : int(this.var_870.getTabCount());
      }
      ...
      {
         var_13 = IFrameWindow(var_136.getXmlWindow("main_window"));
         ...
         var_870 = new ConversationsTabView(var_136,var_13);
         var_870.refresh();
         var_665 = ITextFieldWindow(var_13.findChildByName("message_input"));
         var_665.addEventListener(WindowKeyboardEvent.const_144,onMessageInput);
         var_1281 = new ConversationView(var_136,var_13);
