package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1197:uint = 2;
       
      
      private var var_935:IProtocolDecoder;
      
      private var var_1097:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1097 = new WedgieEncoder();
         var_935 = new WedgieDecoder();
      }
