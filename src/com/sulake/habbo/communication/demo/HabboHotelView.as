package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_728:IAssetLibrary;
      
      private var var_890:uint = 0;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_728.getAssetByName(_loc2_.assetName);
         ...
         else if(param1.type == AssetLoaderEvent.const_35)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_427));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_728.loadAssetFromFile("hotel_view_banner_" + var_890,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      {
         var _loc3_:AssetLoaderStruct = var_728.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
