package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_331.shockwaveClientUrl = var_105.shockwaveClientUrl;
         var_331.ssoTicket = var_105.ticket;
         var_105.removeEventListener(SSOTicket.const_335,onParsedTicketSuccess);
         var_105.removeEventListener(SSOTicket.const_262,onParsedTicketFailure);
         var_105 = null;
      ...
      private function createWindow() : void
      {
         ...
         _window = var_331.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_393,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function initSSOTicket() : void
      {
         ...
         var_105 = new SSOTicket(var_331.assets,_loc2_,_loc1_);
         var_105.addEventListener(SSOTicket.const_335,onParsedTicketSuccess);
         var_105.addEventListener(SSOTicket.const_262,onParsedTicketFailure);
      }
