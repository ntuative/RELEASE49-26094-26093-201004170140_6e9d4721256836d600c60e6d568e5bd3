package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1848:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1481:ILogger;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1298:
            case DisconnectReasonEvent.const_1285:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1272:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1327:
      ...
      private function method_10(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1850)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1220,var_1849));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1848);
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1220 = _habboConfiguration.getKey("flash.client.url","");
         var_1849 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_169 == null)
         {
         ...
         if(var_682 != null)
         {
            var_63.mode = HabboConnectionType.const_418;
            var_63.initConnection(HabboConnectionType.const_249);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1481 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               _loc3_.addEventListener(Event.CLOSE,method_10);
            }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1848 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_63.mode)
         {
            case HabboConnectionType.const_418:
               _loc6_ = "";
               ...
               break;
            case HabboConnectionType.const_858:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1330:
               var_582 = generateRandomHexString(30);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_63.mode = HabboConnectionType.const_858;
            }
         }
         var_63.initConnection(HabboConnectionType.const_249);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_154,onConfigurationLoaded);
         }
      }
