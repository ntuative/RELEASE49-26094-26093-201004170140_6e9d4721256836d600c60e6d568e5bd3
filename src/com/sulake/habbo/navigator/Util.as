package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1409:CutToHeight = new CutToHeight();
      
      private static var var_1408:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1409.beforeSearch(param2,param1,param3);
         binarySearch(var_1409,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1408.beforeSearch(param2,param1,param3);
         binarySearch(var_1408,param2.length - 1);
      }
   }
}
