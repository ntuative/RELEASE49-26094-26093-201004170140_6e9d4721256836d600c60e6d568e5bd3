package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1452,this._model.mode != ThumbnailEditorModel.const_56);
         setEnabled(var_1451,this._model.mode != ThumbnailEditorModel.const_36);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1452 = IButtonWindow(find("top_tab"));
         var_1451 = IButtonWindow(find("obj_tab"));
         var_1778 = IWindowContainer(find("tile_grid"));
         var_1777 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1452,onTopTabButton);
         Util.setProcDirectly(var_1451,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_400)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1777;
