package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1127:int = -16;
      
      private static const const_792:int = 32;
      
      private static const const_1128:int = 8;
      
      public static const const_400:int = 10;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_928 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_928.getImage(ThumbnailEditorModel.const_36,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1127,_loc4_.y + const_1126 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2237[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_928.getImage(ThumbnailEditorModel.const_40,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_928.getImage(ThumbnailEditorModel.const_40,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_928.getImage(ThumbnailEditorModel.const_56,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_792 + _loc3_,param2 * const_1128);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1363 == null)
         {
            var_1363 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1363,var_1363.rect,new Point(0,0),null,null,true);
      }
   }
}
