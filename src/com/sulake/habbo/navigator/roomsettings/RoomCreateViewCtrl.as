package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_773:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_58,80,"g"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_58,74,"h"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_58,416,"o"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_58,352,"p"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_58,304,"q"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_58,336,"r"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_58,748,"u"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_58,438,"v"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_54,540,"t"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_54,512,"w"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_54,396,"x"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_54,440,"y"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_54,456,"z"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_54,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_956 = new TextFieldManager(_navigator,ITextFieldWindow(var_19.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function refresh() : void
      {
         ...
         var_956.input.textBackgroundColor = 4294967295;
         var_773 = var_38[0];
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_956.getText();
      ...
      {
         var _loc1_:Boolean = var_956.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_773.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1123 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1123 = true;
            _loc3_.y = 1;
