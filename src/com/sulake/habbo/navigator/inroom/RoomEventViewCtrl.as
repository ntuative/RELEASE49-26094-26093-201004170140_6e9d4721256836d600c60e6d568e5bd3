package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      {
         var_904.visible = false;
         var_1563.visible = true;
         var_2166.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_741.setText(param1.eventDescription);
         var_903.setText(getTagFromEvent(param1,1));
         var_905.setText(getTagFromEvent(param1,2));
         var_1321.visible = false;
         var_1323.visible = true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1563 = IWindowContainer(find("event_type_disabled_cont"));
            var_2166 = ITextWindow(find("event_type_disabled_text"));
            var_1562 = ITextWindow(find("create_caption"));
            var_1561 = ITextWindow(find("edit_caption"));
            var_1321 = IButtonWindow(find("create_button"));
            var_1323 = IButtonWindow(find("edit_button"));
            var_2165 = IButtonWindow(find("cancel_button"));
            var_1322 = IButtonWindow(find("end_button"));
            var_904 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1321,onCreateButtonClick);
            Util.setProcDirectly(var_1323,onEditButtonClick);
            Util.setProcDirectly(var_1322,onEndButtonClick);
            Util.setProcDirectly(var_2165,onCancelButtonClick);
            ...
            var_903 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_905 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
