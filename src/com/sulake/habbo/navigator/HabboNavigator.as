package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_774:RoomCreateViewCtrl;
      
      private var var_1624:RoomThumbnailRenderer;
      
      private var var_193:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_550:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_444:Tabs;
      
      private var var_244:MainViewCtrl;
      
      private var var_1625:Array;
      
      private var var_993:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_244 = new MainViewCtrl(this);
         var_550 = new RoomInfoViewCtrl(this);
         var_774 = new RoomCreateViewCtrl(this);
         var_1624 = new RoomThumbnailRenderer(this);
         var_993 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_444 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_244.startSearch(Tabs.const_232,Tabs.const_334,param1);
         var_244.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_193 != null)
         {
            var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_244.startSearch(Tabs.const_260,Tabs.const_222);
         var_444.getTab(Tabs.const_260).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_244.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
