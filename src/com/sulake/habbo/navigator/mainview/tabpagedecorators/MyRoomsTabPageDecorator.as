package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_493:IDropMenuWindow;
      
      private var var_2381:IWindowContainer;
      ...
      {
         var _loc1_:int = var_493 == null ? 0 : int(var_493.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_260,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_493 == null)
         {
            var_493 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_493.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
