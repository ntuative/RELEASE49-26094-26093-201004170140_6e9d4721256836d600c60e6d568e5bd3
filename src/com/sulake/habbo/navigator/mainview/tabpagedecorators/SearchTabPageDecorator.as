package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_232,Tabs.const_213,"-1",MainViewCtrl.const_652);
      }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         else if(_navigator.data.guestRoomSearchArrived)
         {
            ...
            if(_navigator.data.guestRoomSearchResults.searchType == Tabs.const_334)
            {
               ...
               _navigator.registerParameter("navigator.tagsearchresults","tag_name",padCommas(_navigator.data.guestRoomSearchResults.include));
               _loc4_.visible = true;
            }
            else
            {
               _navigator.registerParameter("navigator.textsearchresults","room_count","" + _navigator.data.guestRoomSearchResults.rooms.length);
               _navigator.registerParameter("navigator.textsearchresults","search_str","" + _navigator.data.guestRoomSearchResults.include);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(_navigator.data.guestRoomSearchArrived && _navigator.data.guestRoomSearchResults.searchType == Tabs.const_213)
         {
            var_1542.searchStr.setText(_navigator.data.guestRoomSearchResults.include);
         }
