package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_244,Tabs.const_296);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_244,Tabs.const_562);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_244,Tabs.const_296,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_490 == null)
         {
            var_490 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_490.procedure = onChangeFilter;
