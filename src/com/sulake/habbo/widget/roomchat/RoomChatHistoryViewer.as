package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private var var_330:Number = 1;
      
      private var _widget:RoomChatWidget;
      
      private var var_290:Boolean = false;
      
      private var var_216:Number = -1;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_146.state = RoomChatHistoryPulldown.const_205;
         ...
         var_41 = param2.createWindow("chatscroller","",HabboWindowType.const_942,HabboWindowStyle.const_41,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_290 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_216 > 0 && param2)
         {
            if(var_1152)
            {
               if(Math.abs(param1 - var_216) <= const_892)
               {
                  return;
               }
               var_1152 = false;
            ...
            if(var_290)
            {
               ...
               _loc5_ = (param1 - var_216) / 0;
               _loc3_ = var_330 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - var_216;
               _loc7_ = true;
               _loc8_ = true;
               if(var_41.scrollV < 1 - const_1052 / var_41.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1427)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_290 && !var_1377)
         {
            ...
            var_146.state = RoomChatHistoryPulldown.const_290;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_146.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_205);
      }
