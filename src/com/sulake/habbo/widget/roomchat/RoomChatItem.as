package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1437:Number = 10;
      
      private static const const_1438:Number = 8;
      ...
      private var var_199:BitmapData;
      ...
      {
         _widget.onItemMouseOut(var_1065,var_1067,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1065,var_732,var_1067,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1312 = param1.chatType;
         var_1065 = param1.userId;
         var_732 = param1.userName;
         var_1067 = param1.userCategory;
         _message = param1.text;
         var_1314 = param1.userX;
         var_199 = param1.userImage;
      ...
      public function renderView() : void
      {
         ...
         if(var_199 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_199.height);
         }
         ...
         if(var_199 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_199.width;
               _loc28_.height = var_199.height;
               _loc28_.bitmap = new BitmapData(var_199.width,var_199.height,true,0);
               _loc28_.bitmap.copyPixels(var_199,var_199.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_432 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_199.width;
            }
         }
         if(_loc18_ != null)
         {
         ...
         if(_loc20_ != null)
         {
            if(var_1312 == RoomWidgetChatUpdateEvent.const_265)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_732);
            }
            else if(var_1312 == RoomWidgetChatUpdateEvent.const_251)
            {
      ...
      {
         _widget.onItemMouseDown(var_1065,var_1067,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1065,var_1067,_roomId,_roomCategory,param1);
      }
