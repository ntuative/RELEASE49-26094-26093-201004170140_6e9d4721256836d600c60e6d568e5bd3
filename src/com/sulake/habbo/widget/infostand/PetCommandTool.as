package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_1642:int = 1100;
      ...
      private function createCommandWindow() : void
      {
         ...
         var_39.setParamFlag(WindowParam.const_90,true);
         var_39.context.getDesktopWindow().addEventListener(WindowEvent.const_47,onWindowDesktopResized);
      ...
      {
         var _loc2_:Array = var_977.getValue(var_560) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_409,var_560));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_614,var_560,var_1729 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_560);
         }
         else
         {
