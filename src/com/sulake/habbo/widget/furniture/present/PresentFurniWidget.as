package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_710,var_150);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_62,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1042,const_1043,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_188 != null)
         {
            _loc4_.caption = var_188;
         }
