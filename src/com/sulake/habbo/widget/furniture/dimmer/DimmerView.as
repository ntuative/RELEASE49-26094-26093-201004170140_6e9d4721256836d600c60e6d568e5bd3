package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1145:XML;
      
      private var var_437:int;
      
      private var var_463:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1679:int;
      
      private var var_329:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_62,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1042,const_1043,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_463 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_329 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_463 != null)
         {
            var_463.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_329 != null)
         {
            var_329.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_964 = _loc2_.light;
         if(var_329 != null)
         {
            var_329.setValue(var_964);
         }
         var_437 = colors.indexOf(_loc2_.color);
         if(var_463 != null)
         {
            var_463.setSelectedColorIndex(var_437);
         }
