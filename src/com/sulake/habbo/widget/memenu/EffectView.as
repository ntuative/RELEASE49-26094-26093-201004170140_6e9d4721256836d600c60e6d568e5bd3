package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_883 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_882 = _window.findChildByName("loader_bar");
         if(var_882 != null)
         {
            var_387 = var_882.width;
            var_177.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_883 != null)
         {
            var_883.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_883.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
