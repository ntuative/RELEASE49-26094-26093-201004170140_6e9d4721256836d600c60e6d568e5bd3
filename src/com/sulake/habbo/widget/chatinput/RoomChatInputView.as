package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1426:int = 5;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1976 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1975 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_702 = new Timer(1000,1);
         var_702.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_62,HabboWindowStyle.const_41,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _window.addEventListener(WindowEvent.const_361,onWindowMoved);
         var_1267 = true;
         var_124 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1977 = _loc2_.width + const_497 + _loc6_.width + const_1097;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1098,_loc8_.width) + const_497);
            _loc8_.x = _loc12_;
