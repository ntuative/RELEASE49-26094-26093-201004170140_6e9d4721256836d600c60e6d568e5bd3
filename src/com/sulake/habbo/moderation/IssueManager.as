package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_849:String = "issue_bundle_open";
      
      public static const const_535:String = "issue_bundle_my";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_133 = new Map();
         var_912 = new Map();
         var_619 = new IssueBrowser(this,var_57.windowManager,var_57.assets);
         var_747 = [];
         var_913 = [];
         var_1077 = new Map();
      }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_747 = var_747.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_912.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_912.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1177)
         {
            var_151.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_133)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_912.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_912.add(param1.issueId,_loc2_);
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_619 == null || !var_619.method_2())
         {
            var_57.soundManager.playSound(HabboSoundTypesEnum.const_867);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_912.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_133.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
