package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_2164:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2164.clone());
      ...
      {
         var_2164 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
