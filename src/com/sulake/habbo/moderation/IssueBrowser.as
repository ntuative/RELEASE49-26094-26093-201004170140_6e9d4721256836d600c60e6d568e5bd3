package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1464:IIssueBrowserView;
      ...
      private var var_1465:IIssueBrowserView;
      ...
      private var var_1466:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_334.view.width = var_222.container.width;
         var_334.view.height = var_222.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1654:
               if(var_1465 == null)
               {
                  var_1465 = new MyIssuesView(issueManager,this,var_222.container);
               }
               return var_1465;
            case const_1655:
               if(var_1464 == null)
               {
                  var_1464 = new OpenIssuesView(issueManager,this,var_222.container);
               }
               return var_1464;
            case const_1656:
               if(var_1466 == null)
               {
                  var_1466 = new PickedIssuesView(issueManager,this,var_222.container);
               }
               return var_1466;
            default:
               return null;
