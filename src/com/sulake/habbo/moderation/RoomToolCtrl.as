package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_671:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_592,_data.flatId),var_50,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_400);
         if(param1.flatId != var_400)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_400);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_671.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1148,_loc2_,var_431.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_986.isSelected,var_987.isSelected,var_671.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1188);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1230);
      }
      ...
      public function populate() : void
      {
         ...
         var_671 = ICheckBoxWindow(var_50.findChildByName("kick_check"));
         var_986 = ICheckBoxWindow(var_50.findChildByName("lock_check"));
         var_987 = ICheckBoxWindow(var_50.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_400));
         Logger.log("BEGINNING TO SHOW: " + var_400);
      }
   }
}
