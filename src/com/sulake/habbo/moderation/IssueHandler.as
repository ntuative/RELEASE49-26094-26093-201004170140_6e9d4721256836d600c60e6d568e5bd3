package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_413:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_57.issueManager.releaseBundle(var_107.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_413 = new UserInfoCtrl(_window,var_57,_loc3_.message);
         var_1012 = new UserInfoCtrl(_window,var_57,_loc3_.message);
         var_413.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_107.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1012.load(_loc4_,var_107.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_57.issueManager.closeBundle(var_107.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         if(var_57 != null && false && var_107 != null)
         {
            var_57.issueManager.removeHandler(var_107.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_413 = new UserInfoCtrl(_window,var_57,_loc3_.message);
            var_413.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_57.issueManager.closeBundle(var_107.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_57.issueManager.closeBundle(var_107.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1314;
      }
   }
}
