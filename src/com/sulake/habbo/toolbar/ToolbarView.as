package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1606:Number = 5;
      
      private var var_284:Array;
      
      private var var_140:Number = 50;
      
      private var var_1379:Number = 0;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_206 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_62,HabboWindowStyle.const_913,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1105 = String(_loc7_.relocate_by_drag.@state) == "ICatalogNavigator";
         if(var_1105)
         {
         ...
         var_1379 = _loc7_.toolbar.@margin_bottom;
         var_1607 = _loc7_.toolbar.@min_group_margin;
         var_1606 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         method_4(_loc8_,var_284,param1,param2,_window,var_269);
         method_4(_loc9_,var_633,param1,param2,var_206,var_269);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_140,var_540,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1607,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1379) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1607,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1379) / -1));
      ...
      {
         if(var_1105 && var_1106)
         {
            var_1106 = false;
         }
      }
      
      private function method_4(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc9_:* = null;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_140,var_540);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_140,var_540);
         }
      }
