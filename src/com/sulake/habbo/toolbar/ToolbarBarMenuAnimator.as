package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1105:int = 50;
      ...
      private var var_1048:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_512.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_512.splice(_loc3_,1);
            var_511.splice(_loc3_,1);
         }
         var_511.push(param1.name);
         var_512.push(param2);
         param1.addEventListener(WindowEvent.const_361,windowEventListener);
         param1.addEventListener(WindowEvent.const_196,windowEventListener);
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1048.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1048.getIconLoc(param1.iconId);
      ...
      {
         return param1.x + param1.width < const_780 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_780 || param1.desktop.height - param1.y < const_1105;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_511[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
