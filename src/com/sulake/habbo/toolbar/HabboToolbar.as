package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_890,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_402,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_600,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_932,onHideWindowEvent);
         var_32 = true;
