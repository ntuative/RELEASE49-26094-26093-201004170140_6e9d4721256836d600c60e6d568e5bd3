package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      private var var_1040:ToolbarIconBouncer;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _events:IEventDispatcher;
      
      private var var_2331:Array;
      
      private var var_269:ToolbarBarMenuAnimator;
      
      private var var_422:ToolbarIconAnimator;
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         var_868 = new Array();
         var_2331 = new Array();
         var_1040 = new ToolbarIconBouncer(0.8,1);
         super();
         var_508 = param1;
         ...
         var_95 = param2.createWindow("TOOLBAR_ICON_" + param4 + "_REGION","",WindowType.const_451,HabboWindowStyle.const_41,HabboWindowParam.const_43,new Rectangle(0,0,1,1),onMouseEvent) as IRegionWindow;
      ...
      {
         return var_1536[var_1039.indexOf(param1)];
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(var_269)
               {
                  var_269.repositionWindow(var_707,true);
               }
               if(_events != null)
               {
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = var_868[var_600.indexOf(param1)];
      ...
      private function setTooltip() : void
      {
         ...
         {
            var_95.toolTipCaption = "${toolbar.icon.tooltip." + var_2026.toLowerCase() + "}";
         }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         if(var_269 != null)
         {
            var_269.animateWindowIn(this,param1,param2,var_707,param3,param4,getMenuYieldList(param1));
         }
      }
      
      private function updateAnimator(param1:Event) : void
      {
         if(var_422 != null && _window != null)
         {
            var_422.update(_window);
            if(var_422.hasNextState())
            {
               state = var_422.nextState;
            }
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         var_1039 = new Array();
         var_2026 = param1.@id;
         var_2027 = int(param1.@window_offset_from_icon);
         var_2028 = int(param1.@window_margin);
         ...
         if(_loc2_.length() > 0)
         {
            ...
            while(_loc3_ < _loc2_.length())
            {
               ...
               var_1039.push(_loc5_.id);
               var_1536.push(_loc5_);
               if(_loc3_ == 0)
               {
                  if(var_1041 == "-1")
                  {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_269 != null)
         {
            var_269.hideWindow(param1,param2,var_707,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_269 != null)
         {
            var_269.positionWindow(this,param1,param2,var_707,param3,getMenuYieldList(param1));
         }
      }
      ...
      {
         if(var_1040 != null && _window != null)
         {
            var_1040.update();
            _window.y = var_1040.location;
         }
      }
      ...
      private function setAnimator() : void
      {
         ...
         var _loc1_:StateItem = getCurrentStateObject();
         if(_loc1_ != null && var_1042)
         {
            if(_loc1_.frames == null)
            {
               return;
            }
            var_422 = new ToolbarIconAnimator(_loc1_,_assetLibrary,_window,var_82,_y,_bitmapData);
            if(false)
            {
      ...
      {
         return var_2028 + var_508.windowMargin;
      }
