package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_31:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_692);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1026);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1028);
            ...
            case RoomObjectCategoryEnum.const_37:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_325)
               {
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_520);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_194)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_544);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1247;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1023;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1181);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_544);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_732);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_586);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_741);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1300);
         _loc1_.push(RoomWidgetPetCommandMessage.const_614);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_648:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_834,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_248:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_732:
            ...
            case RoomWidgetUserActionMessage.const_409:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_586:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_741:
            ...
            case RoomWidgetPetCommandMessage.const_718:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_614:
