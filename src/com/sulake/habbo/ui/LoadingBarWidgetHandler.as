package com.sulake.habbo.ui
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_100:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_275:
               _container.events.dispatchEvent(param1);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(AdEvent.const_391);
         _loc1_.push(AdEvent.const_445);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_100);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_275);
         return _loc1_;
      }
