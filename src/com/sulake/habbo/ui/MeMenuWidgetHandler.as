   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_890,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_420,onHelpTutorialEvent);
         ...
         if(var_10 != null)
         {
            ...
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_820,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_420,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_104:
               ...
               break;
            case HabboHelpTutorialEvent.const_420:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_388));
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_613);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_525);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_526);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_742);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_651);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_524);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_731);
         _loc1_.push(RoomWidgetStopEffectMessage.const_688);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1164);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_954);
         _loc1_.push(RoomWidgetToolbarMessage.const_559);
         _loc1_.push(RoomWidgetToolbarMessage.const_675);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_707);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1145);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_873);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_550);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_682);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_695);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1174);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_659);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_711);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_572);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_646));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_516:
               ...
               break;
            case RoomWidgetDanceMessage.const_613:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_525:
               if(var_10 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_742:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_731:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_903)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_195,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_524:
               ...
               if(var_10 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_843:
                        _catalog.openCatalogPage(CatalogPageName.const_1184,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_809:
                        var_10.toggleInventoryPage(InventoryCategory.const_236);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1158:
                        var_10.toggleInventoryPage(InventoryCategory.const_75);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1384:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_651:
            case RoomWidgetStopEffectMessage.const_688:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_868:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_954:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_550:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_559:
               ...
               if(var_193)
               {
                  var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_675:
               ...
               if(var_193 && false)
               {
                  var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_402,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_707:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_475));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_695:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_659:
            ...
            case RoomWidgetStoreSettingsMessage.const_711:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_328,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_572:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_457));
               }
               break;
            default:
