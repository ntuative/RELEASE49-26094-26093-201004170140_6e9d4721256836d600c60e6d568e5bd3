package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetChatMessage.const_582,RoomWidgetChatSelectAvatarMessage.const_551];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_582:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_141,_container.roomSession,0,"Version 26094-26093-201004170047");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_551:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_828 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_828);
            }
            if(var_489 == null)
            {
               var_488.x = 0;
