package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_823:IRoomWidgetFactory;
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_528 = param2 as IHabboSoundManager;
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_107:
               if(param1.session != null)
               {
                  ...
                  var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.ZOOM));
                  var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.MEMENU));
                  var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            var_261.events.addEventListener(AdEvent.const_445,adEventHandler);
            var_261.events.addEventListener(AdEvent.const_391,adEventHandler);
            var_261.events.addEventListener(AdEvent.const_429,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_823 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_823 != null)
         {
            var_823.release(new IIDHabboRoomWidget());
            var_823 = null;
         }
         if(var_10 != null)
         {
         ...
         if(var_528 != null)
         {
            var_528.release(new IIDHabboSoundManager());
            var_528 = null;
         }
         if(var_261 != null)
         {
         ...
         if(var_561 != null)
         {
            var_561.release(new IIDAvatarRenderManager());
            var_561 = null;
         }
         if(_catalog != null)
         {
         ...
         if(var_678 != null)
         {
            var_678.release(new IIDHabboModeration());
            var_678 = null;
         }
         if(_navigator != null)
         {
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_517)
            {
               var_1470 = _loc3_;
            }
            _loc2_.dispose();
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_678 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + var_678);
      }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_595:
               ...
               if(var_1470 != RoomDesktop.const_517)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_250,var_1470);
               }
               if(var_261 != null)
               {
                  var_261.showRoomAd();
            ...
            case RoomEngineEvent.const_571:
               ...
               break;
            case RoomEngineRoomColorEvent.const_508:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_677,roomEngineEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_66,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_508,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_644,roomObjectEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_533,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_218,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_588,roomObjectEventHandler);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_561 = param2 as IAvatarRenderManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(var_18)
         {
            var_18.events.addEventListener(RoomSessionEvent.const_302,roomSessionStateEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionUserBadgesEvent.const_118,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_102,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_134,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_57,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionPresentEvent.const_245,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_567,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_714,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_179,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_734,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_626,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionQueueEvent.const_424,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionVoteEvent.const_121,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionVoteEvent.const_129,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionPollEvent.const_133,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionFriendRequestEvent.const_127,roomSessionEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_677)
         {
            if(var_18 != null)
            {
               var_18.roomEngineReady = true;
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1206 = param2 as IHabboAvatarEditor;
      }
   }
}
