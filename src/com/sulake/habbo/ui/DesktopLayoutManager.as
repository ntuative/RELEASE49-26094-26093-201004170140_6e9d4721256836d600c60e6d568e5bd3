package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1663:String = "room_widget";
      
      private const const_1119:String = "room_view";
      
      private var var_54:IWindowContainer;
      
      private var var_755:int = 50;
      
      private var var_2343:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_54.getChildByTag(const_1119) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_54.findChildByTag(const_1119) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_755;
               _loc2_.width = var_54.desktop.width - var_755;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_755;
               _loc2_.height = var_54.desktop.height - var_755;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_54.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_54.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_240,trimContainer);
            }
            _loc5_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1663) == 0)
            {
