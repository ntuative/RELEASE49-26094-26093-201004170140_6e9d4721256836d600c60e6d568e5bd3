package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_619);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_639);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_634);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_619:
               ...
               if(_loc4_)
               {
                  _loc5_ = _container.roomEngine.getRoomObjectBoundingRectangle(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_37,_container.getFirstCanvasId());
            ...
            case RoomWidgetFriendRequestMessage.const_639:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_634:
