package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_800:AvatarEditorHandler;
      ...
      private const const_1054:int = 2;
      ...
      private function init() : void
      {
         ...
         if(!var_158)
         {
            ...
            var_471["null"] = new FigureData(this);
            var_471["null"] = new FigureData(this);
            _loc1_ = var_471["null"];
            _loc2_ = var_471["null"];
            ...
            var_86 = new Map();
            var_391 = new Map();
            var_86.add(AvatarEditorFigureCategory.const_801,new BodyModel(this));
            var_86.add(AvatarEditorFigureCategory.const_49,new HeadModel(this));
            var_86.add(AvatarEditorFigureCategory.const_324,new TorsoModel(this));
            var_86.add(AvatarEditorFigureCategory.const_1215,new LegsModel(this));
            var_86.add(AvatarEditorFigureCategory.const_1292,new HotLooksModel(this));
            var_391.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_391.add(AvatarEditorSideCategory.const_377,new ClubPromoModel(this));
            var_158 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_978 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1436;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_978 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1054)
                  {
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1381)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_978 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_391.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_800 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_801);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_661 = var_561.getFigureData(AvatarType.const_82);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_561 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_978 = param3;
         var _loc4_:FigureData = var_471[param2];
         if(_loc4_ == null)
         {
            return;
         }
