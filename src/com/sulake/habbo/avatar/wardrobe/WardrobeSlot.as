package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit
   {
      ...
      private function createView() : void
      {
         ...
         _view.visible = false;
         var_297 = _view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(var_295 && var_1241)
         {
            _loc5_ = var_47.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.SMALL,var_587);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_39,parseInt(FigureData.const_694));
         ...
         if(var_297)
         {
            if(false)
            {
               var_297.bitmap.dispose();
            }
            var_297.bitmap = new BitmapData(var_297.width,var_297.height,true,0);
            _loc7_ = (0 - _loc1_.width) / 2;
            _loc8_ = (0 - _loc1_.height) / 2;
            var_297.bitmap.draw(_loc1_,new Matrix(1,0,0,1,_loc7_,_loc8_));
         }
         if(_loc2_)
         {
            _loc1_.dispose();
         ...
         if(_loc4_)
         {
            _loc4_.visible = var_1241 && var_295 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               var_295 = var_47.figureData.getFigureString();
               var_587 = var_47.gender;
            ...
            case "get_button":
               if(var_295)
               {
                  var_47.loadAvatarInEditor(var_295,var_587,var_47.clubMemberLevel);
               }
         }
      }
   }
