package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_704:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_704 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1037 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_704)
         {
            var_704.removeListItems();
         }
         if(var_1037)
         {
            var_1037.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_704)
               {
                  var_704.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1037)
            {
               var_1037.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
