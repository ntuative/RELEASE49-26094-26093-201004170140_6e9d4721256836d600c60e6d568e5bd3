   ...
   public class AvatarActionManager
   {
      ...
      private function filterActions(param1:Array) : Array
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            _loc5_ = var_191[_loc4_.actionType] as ActionDefinition;
            if(_loc5_ != null)
            {
      ...
      public function sortActions(param1:Array) : Array
      {
         ...
         {
            _loc4_ = var_191[_loc3_.actionType];
            if(_loc4_ != null)
            {
      ...
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         ...
         while(_loc7_ < param1.length)
         {
            ...
            _loc6_ = var_191[_loc5_.actionType] as ActionDefinition;
            if(_loc6_ != null && _loc6_.method_8(param2,param3) != null)
            {
               _loc4_ = _loc6_.method_8(param2,param3);
            }
            _loc7_++;
         }
         return _loc4_;
