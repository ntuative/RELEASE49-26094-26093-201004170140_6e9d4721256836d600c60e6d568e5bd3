package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_653 >= 0 && var_163.length > var_653)
         {
            _loc2_ = var_163[var_653];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_163.length > param1)
         {
            _loc3_ = var_163[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc1_:Array = var_215[0] as Array;
         ...
         while(_loc5_ < var_187.length)
         {
            ...
            {
               if(_loc7_.length > var_187[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_187[param2],param2);
         var_187[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_187[param1])
         {
            return null;
         }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(var_215.length <= param1)
         {
            return null;
         }
         return var_215[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return var_163[var_653] as AvatarEditorGridPartItem;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_215)
         {
            for each(_loc2_ in var_215 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_187 = new Array(param1.length);
         var _loc3_:int = 0;
