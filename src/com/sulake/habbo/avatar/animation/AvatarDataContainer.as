package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1523:Number = 1;
      
      private var var_1990:Boolean = true;
      
      private var var_1399:uint;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         var_1526 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         var_1989 = parseInt(_loc2_,16);
         var_1988 = parseInt(_loc3_,16);
         _rgb = parseInt(_loc2_,16);
         var_1399 = _rgb >> 16 & 255;
         var_1400 = _rgb >> 8 & 255;
         _b = _rgb >> 0 & 255;
         var_1523 = var_1399 / 255 * 1;
         var_1524 = var_1400 / 255 * 1;
         var_1525 = _b / 255 * 1;
         if(var_1526 == 37)
         {
         ...
         _colorTransform = new ColorTransform(var_1523,var_1524,var_1525,_alphaMultiplier);
         var_1036 = generatePaletteMapForGrayscale(var_1988,var_1989);
      }
      
      public function get reds() : Array
      {
         return var_1036.getValue("reds") as Array;
      }
      ...
      {
         return var_1036.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1036.getValue("greens") as Array;
      }
      ...
      {
         return var_1036.getValue("alphas") as Array;
      }
