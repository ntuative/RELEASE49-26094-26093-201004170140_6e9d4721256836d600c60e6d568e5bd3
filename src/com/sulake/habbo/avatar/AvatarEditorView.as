package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1515:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_497:IFrameWindow;
      ...
      private function createWindow() : void
      {
         ...
         var_1515 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         update();
      }
      ...
      public function update() : void
      {
         ...
         if(var_47.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1516 == AvatarEditorSideCategory.WARDROBE || var_1967))
         {
            _loc4_ = "null";
         }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_497)
         {
            ...
            var_497 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_497.procedure = stripClubDialogEventProc;
            var_497.center();
         }
         else
         {
            var_497.visible = true;
            var_497.center();
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_663:
               break;
            case AvatarEditorSideCategory.const_377:
               _loc3_ = var_47.getSideContentWindowContainer(AvatarEditorSideCategory.const_377);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_268 = param1;
         var_1515.setSelected(var_1515.getSelectableByName(param1));
         _window.invalidate();
      }
      
      private function toggleWardrobe() : void
      {
         if(var_1516 == AvatarEditorSideCategory.WARDROBE)
         {
            var_1967 = false;
            setSideContent(AvatarEditorSideCategory.const_663);
         }
         else
         {
