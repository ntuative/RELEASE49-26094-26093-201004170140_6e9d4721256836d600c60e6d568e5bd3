package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1081:String = AvatarSetType.const_39;
      ...
      private var var_295:AvatarFigureContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String, param6:String = null)
      {
         ...
         if(var_190 == null)
         {
            var_190 = AvatarScaleType.const_55;
         }
         ...
         var_295 = new AvatarFigureContainer(param3);
         if(param6)
         {
            ...
            if(_loc7_)
            {
               ...
               {
                  if(!var_295.hasPartType(_loc9_))
                  {
                     _loc10_ = var_51.getDefaultPartSet(_loc9_,param6);
                     if(_loc10_)
                     {
                        var_295.updatePart(_loc9_,_loc10_.id,[0]);
                     }
                  }
                  else
                  {
                     _loc11_ = _loc8_.getSetType(_loc9_);
                     _loc12_ = _loc11_.getPartSet(var_295.getPartSetId(_loc9_));
                     if(!_loc12_)
                     {
                        _loc13_ = var_51.getDefaultPartSet(_loc9_,param6);
                        var_295.updatePart(_loc9_,_loc13_.id,[0]);
                     }
                  }
               }
            }
         ...
         {
            _loc14_ = var_295.getPartSetId("pbd");
            solvePetAvatarTypeAndBreed(_loc14_);
            var_1232 = var_1010;
         }
         var_125 = new AvatarImageCache(var_51,this,_assets,var_190);
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1231;
         if(param2 < AvatarDirectionAngle.const_1386)
         {
            param2 = AvatarDirectionAngle.const_576 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_576)
         {
            param2 -= NaN;
         }
         if(var_656 == AvatarType.PET && param1 == AvatarSetType.const_49)
         {
            if((var_90 == 6 || var_90 == 0) && param2 == 7)
            {
               param2 = var_90;
            }
            _loc3_ = var_51.renderManager.petDataManager.getPetData(var_1232);
            if(_loc3_ != null)
            {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         var_412 = false;
         var _loc1_:Array = var_51.sortActions(var_191);
         if(_loc1_ == null)
         {
            var_586 = new Array(0,0,0);
         }
         else
         {
            var_586 = var_51.getCanvasOffsets(_loc1_,var_190,var_90);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1231 = _loc3_.directionData.offset;
                  }
                  if(_loc3_.hasAvatarData())
                  {
                     var_491 = _loc3_.avatarData;
                  }
               }
            }
            ...
            if(_loc2_.actionType == AvatarAction.const_365)
            {
               var_412 = true;
            }
      ...
      {
         return var_51.getPartColor(var_295,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_51.getCanvas(var_190,var_170.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_51.getBodyParts(param1,var_170.definition,var_90);
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_656 == AvatarType.PET)
               {
                  ...
                  _loc17_ = var_51.getParts(_loc9_,var_295,_loc15_,"pet",_loc14_.getDirection(),[]);
                  _loc18_ = 32;
                  if(var_190 == AvatarScaleType.SMALL)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_51.getPartActionOffset(getSubType(),var_190,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = var_51.getCanvas(var_190,var_170.definition.geometryType);
         if(_image == null || _loc4_ != null && (_image.width != _loc4_.width || _image.height != _loc4_.height))
         {
            _loc4_ = var_51.getCanvas(var_190,var_170.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               if(var_656 == AvatarType.PET)
               {
                  ...
                  _loc15_ = var_51.getParts(_loc8_,var_295,_loc13_,"pet",_loc12_.getDirection(),[]);
                  _loc16_ = var_1232 < 3;
                  ...
                  if(_loc15_.length > 0)
                  {
                     ...
                     _loc22_ = var_51.getPartActionOffset(getSubType(),var_190,_loc8_,_loc14_,_loc19_,_loc20_);
                     if(_loc22_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_170 = new ActiveActionData(AvatarAction.const_893);
         var_170.definition = var_51.getActionDefinition(const_1080);
      ...
      {
         return var_51.getBodyPartData(param1.animation.id,var_492,param1.id);
      }
