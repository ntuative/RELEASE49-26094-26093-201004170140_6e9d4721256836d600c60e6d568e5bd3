package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_386:PartSetsData;
      
      private var var_1716:PartOffsetData;
      
      private var var_795:AvatarActionManager;
      
      private var var_164:IAssetLibrary;
      
      private var var_972:IAssetLibrary;
      
      private var var_1717:AvatarRenderManager;
      
      private var var_291:FigureData;
      ...
      private var var_1428:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_164 = param2;
         var_972 = param3;
         var_291 = new FigureData();
         var_386 = new PartSetsData();
         _animationData = new AnimationData();
         var_1428 = new AvatarStructureDownloadSet();
         var_655 = new AnimationManager();
         var_656 = param4;
         var_1716 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_795.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_795.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_291.appendXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_795.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_386.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_386.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1392[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_795.getDefaultActionType();
         var _loc9_:Array = var_386.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_655.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_291.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_291.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_386.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_386.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_656 + " ready to go!");
         if(var_656 == AvatarType.const_82)
         {
            var_386.getPartDefinition("ri").appendToFigure = true;
            var_386.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_82:
               if(var_164.hasAsset(_loc5_))
               {
                  var_164.removeAsset(var_164.getAssetByName(_loc5_));
               }
               var_1428.add(new AvatarStructureDownload(var_164,_loc5_,var_291));
               break;
            case AvatarType.PET:
         }
         var_1428.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_795 = new AvatarActionManager(var_164,var_656);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1153 = var_291.getMandatorySetTypeIds();
         return var_1153;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_291.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_972.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_972.getAssetByName("dance" + _loc1_).content as XML;
            var_655.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_972.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_972.getAssetByName("fx" + _loc1_).content as XML;
            var_655.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_1716.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_291.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_291.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_795.sortActions(param1);
      }
   }
}
