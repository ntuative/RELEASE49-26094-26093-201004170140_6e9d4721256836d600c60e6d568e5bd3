package com.sulake.habbo.session.handler
{
   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      public static const const_930:String = "RS_CONNECTED";
      
      public static const const_611:String = "RS_DISCONNECTED";
      
      public static const const_851:String = "RS_READY";
      ...
      private function onRoomQueueStatus(param1:RoomQueueStatusMessageEvent) : void
      {
         ...
         for each(_loc9_ in _loc6_)
         {
            ...
            {
               _loc5_.method_6(_loc10_,_loc4_.getQueueSize(_loc10_));
            }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            ...
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_851);
         }
      }
      ...
      private function onRoomConnected(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_930);
         }
      }
   }
}
