package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_766:ITextFieldWindow;
      ...
      {
         var_766 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_766.procedure = onSearchInput;
         var_766.addEventListener(WindowKeyboardEvent.const_144,onSearchStrInput);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_363.showPopup(_friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_48.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_299,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_766.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
