package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1444:String = "no_reqs_info";
      ...
      private var var_1592:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_311 && _loc4_.state != FriendRequest.const_320)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_311;
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         var_1592 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1592.procedure = onDismissAllButtonClick;
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_311)
         {
         ...
         else if(param1.state == FriendRequest.const_818)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_311;
