package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_230.length / const_319);
      }
      ...
      {
         if(this.var_884 >= this.getPageCount())
         {
            this.var_884 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_884 + 1) * const_319,this.var_230.length);
      }
