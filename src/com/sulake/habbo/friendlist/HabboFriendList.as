package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1549:OpenedToWebPopup;
      
      private var var_864:IAvatarRenderManager;
      ...
      private var var_1550:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_605:ISessionDataManager;
      ...
      private var var_2061:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_871:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2061 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_86 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1550 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_444.findTab(FriendListTab.const_89).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_605 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_86.addCategory(new FriendCategory(FriendCategory.const_984,getText("friendlist.friends")));
         var_86.addCategory(new FriendCategory(FriendCategory.const_434,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_86.addFriend(new Friend(_loc4_));
         }
         var_444 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_510)
         {
            var_510 = new Timer(120000);
            var_510.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_510.start();
         }
         getBuddyRequests();
         registerListeners();
         var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_510.stop();
            var_510.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_510 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_136)
         {
            var_136.release(new IIDHabboMessenger());
            var_136 = null;
         }
         if(var_148)
         {
         ...
         if(var_864)
         {
            var_864.release(new IIDAvatarRenderManager());
            var_864 = null;
         }
         if(var_871)
         {
            var_871.release(new IIDHabboNotifications());
            var_871 = null;
         }
         if(var_193)
         {
         ...
         if(var_605)
         {
            var_605.release(new IIDSessionDataManager());
            var_605 = null;
         }
         super.dispose();
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_91);
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "ICatalogNavigator";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_444.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1550.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_605.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_605.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
      ...
      {
         var _loc2_:FriendListTab = var_444.findTab(FriendListTab.const_89);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_864.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_444.findTab(FriendListTab.const_89);
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1549 == null)
         {
            var_1549 = new OpenedToWebPopup(this);
         }
         var_1549.show(x,y);
      }
