package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_531:String = "bg";
       
      
      private var var_1912:IContainerButtonWindow;
      
      private var var_1913:IContainerButtonWindow;
      
      private var var_1914:IContainerButtonWindow;
      ...
      {
         _friendList = param1;
         var_363 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_1913 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1914 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1912 = initButton("room_invite",onInviteButtonClick,param1);
         var_1911 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_531);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_91,param4);
         _loc6_.visible = true;
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_363.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_32)
         {
            this.var_363.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_252)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_252 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1913,isEnableMinimailButton(_loc1_));
         setEnabled(var_1914,isEnableHomeButton(_loc1_));
         setEnabled(var_1912,isEnableInviteButton(_loc1_));
         setEnabled(var_1911,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_531);
         _loc7_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_91,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         _friendList.tabs.findTab(FriendListTab.const_91).setNewMessageArrived(true);
      }
      ...
      {
         return _friendList.laf.getRowShadingColor(FriendListTab.const_91,param1);
      }
