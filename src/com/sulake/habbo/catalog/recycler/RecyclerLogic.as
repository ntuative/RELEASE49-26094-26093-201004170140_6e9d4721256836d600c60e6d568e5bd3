package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1417)
         {
            case RecyclerStatusMessageEvent.const_1276:
               ...
               break;
            case RecyclerStatusMessageEvent.const_925:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1153:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1417 != RecyclerStatusMessageEvent.const_925;
      }
      
      private function get statusActive() : Boolean
      {
         return var_248 != const_754;
      }
      ...
      {
         return active && var_248 == const_345;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_810:
               if(_view != null)
               {
