package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1494:XML;
      ...
      private var var_1492:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1494 == null)
         {
            ...
            var_1494 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1492 == 4294967295)
            {
               var_1492 = _loc1_.color;
            }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1208;
            }
         }
      }
      ...
      override public function get method_2() : Boolean
      {
         return var_1009;
      }
      ...
      {
         var_48 = navigator.catalog.windowManager.buildFromXML(var_1494) as IItemListWindow;
         if(var_48 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1284;
            }
         }
      }
