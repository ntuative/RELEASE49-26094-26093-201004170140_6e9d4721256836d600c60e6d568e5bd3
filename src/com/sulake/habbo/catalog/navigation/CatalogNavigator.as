package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2366:String = "magic.pixels";
      
      private var var_2365:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_590,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_269,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.WINDOW_EVENT_DISABLE,deActivateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_196,deActivateScrollbar);
         }
      }
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","RoomWidgetStoreSettingsMessage") == "ICatalogNavigator";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2365,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_270.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.method_2;
         var _loc4_:* = [];
         for each(_loc5_ in var_270)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_270.indexOf(_loc6_);
            var_270.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
