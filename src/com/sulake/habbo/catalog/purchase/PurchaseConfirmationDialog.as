package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1432:uint = 4.294967295E9;
      
      private const const_1433:uint = 4.293848814E9;
      
      private var var_782:int;
      
      private const const_1637:uint = 4.291613146E9;
      ...
      private const const_1638:int = 10;
      ...
      {
         return param1 % 2 == 0 ? uint(const_1433) : uint(const_1432);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_408,var_75,var_962);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_247) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(var_554[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_553[var_185]);
         _catalog.purchaseProductAsGift(var_408,var_75,var_962,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
         ...
         switch(param1.type)
         {
            case WindowEvent.const_126:
               ...
               for each(_loc7_ in var_230)
               {
                  ...
                  if(_loc5_.length >= const_1638)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1664 = _loc3_.text;
               break;
            case WindowMouseEvent.const_53:
               showSuggestions(false);
               if(var_1138)
               ...
               break;
            case WindowKeyboardEvent.const_593:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_247 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_247 + 1);
                     break;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1407 = _loc1_.stuffTypes;
            var_554 = _loc1_.boxTypes;
            var_553 = _loc1_.ribbonTypes;
            var_783 = var_1407[0];
            _boxIndex = var_554[0];
            var_185 = var_553[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(var_247) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_247);
         }
         var_247 = param1;
         if(var_247 < 0)
         {
            var_247 = _loc2_.numListItems - 1;
         }
         if(var_247 >= _loc2_.numListItems)
         {
            var_247 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_247) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_460 == null)
         {
            var_460 = createWindow("suggestion_list_item") as IWindowContainer;
            var_460.procedure = suggestionsEventHandler;
         }
         if(var_213 == null || var_460 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_213.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_460.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
