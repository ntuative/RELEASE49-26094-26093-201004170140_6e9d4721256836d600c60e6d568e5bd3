package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         var_305 = null;
         for each(_loc1_ in var_1358)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1357) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_727.width,var_727.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_727,var_727.rect,new Point(0,0),null,null,true);
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         var_727 = _loc4_.content as BitmapData;
         populateColourGrid();
