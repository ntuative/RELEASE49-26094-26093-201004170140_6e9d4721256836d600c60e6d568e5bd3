package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1266:XML;
      
      private var var_305:IGridItem;
      
      private var var_1265:XML;
      ...
      override public function init() : void
      {
         ...
         var_1266 = _loc1_.content as XML;
         populateItemGrid();
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1266) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1265) as IWindowContainer;
