package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1164:IScrollbarWindow;
      
      protected var var_1265:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1228.text = "${" + _loc3_.name + "}";
            var_1229.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1228.text = "${" + _loc2_.localizationId + "}";
            var_1229.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_374:
                  _loc4_ = var_1163.clone();
                  if(var_562 != null)
                  {
                     var_562.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_562,var_1164,var_1265);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_228:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_309,AvatarAction.const_628);
                              _loc13_.appendAction(AvatarAction.const_696,_loc6_.productClassId);
