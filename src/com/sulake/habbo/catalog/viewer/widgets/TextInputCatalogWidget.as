package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_976 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_976 != null)
         {
            var_976.addEventListener(WindowKeyboardEvent.const_593,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_976.text));
      }
   }
}
