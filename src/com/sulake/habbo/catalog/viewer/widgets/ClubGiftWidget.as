package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_575.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_207)
         {
            var_207 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_207)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_207.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_207.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
         var_207.visible = true;
         var_207.activate();
      }
      ...
      {
         if(!param1 || !param2 || !var_575 || !var_47)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_575.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
