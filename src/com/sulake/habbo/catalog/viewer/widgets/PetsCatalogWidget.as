package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_437 >= var_311.length)
         {
            return "";
         }
         var petColor:IPetColor = var_311[var_437] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_617[var_1565] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_437 < 0 || var_437 > var_311.length)
         {
            var_437 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_575.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         events.addEventListener(WidgetEvent.const_991,onApproveNameResult);
         _loc5_ = var_575.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_575.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_437 >= 0 && var_437 < var_311.length)
         {
            _loc7_ = var_311[var_437] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_617[var_1565] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_909,_loc3_.id,_loc2_,AvatarScaleType.const_55);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_309,AvatarAction.const_719);
