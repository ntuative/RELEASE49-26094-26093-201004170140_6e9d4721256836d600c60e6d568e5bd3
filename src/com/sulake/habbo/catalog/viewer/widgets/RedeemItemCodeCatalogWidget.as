package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1083:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1083 != null)
         {
            var_1083.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1084 != null)
         {
            var_1084.removeEventListener(WindowKeyboardEvent.const_144,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1083 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1083 != null)
         {
            var_1083.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1084 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1084 != null)
         {
            var_1084.addEventListener(WindowKeyboardEvent.const_144,windowKeyEventProcessor);
         }
      }
