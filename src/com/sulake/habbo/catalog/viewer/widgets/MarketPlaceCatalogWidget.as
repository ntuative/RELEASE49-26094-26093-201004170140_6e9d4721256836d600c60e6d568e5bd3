package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_819:MarketPlaceOfferData;
      
      private const const_1416:int = 1;
      
      private const const_1652:int = 40;
      ...
      private function updateList() : void
      {
         ...
         if(!var_477)
         {
            ...
            var_477 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_477)
         {
            return;
         ...
         if(!var_402)
         {
            var_402 = new Timer(25);
            var_402.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_820 = 0;
         populateList();
         var_402.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_575)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_477 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_477.clone() as IWindowContainer;
      ...
      override public function dispose() : void
      {
         ...
         if(var_402)
         {
            var_402.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_402 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_820 >= var_575.length)
            {
               return true;
            }
            addListItem(var_575.getWithIndex(var_820));
            ++var_820;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_819.offerId);
            }
            return;
         }
