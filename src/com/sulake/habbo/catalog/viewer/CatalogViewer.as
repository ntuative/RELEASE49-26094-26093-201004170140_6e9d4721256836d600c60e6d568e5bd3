package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1457:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_408 != null)
         {
            if(var_408.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_408.window);
            var_408.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1457);
         var_408 = _loc5_;
      ...
      {
         return var_408.dispatchWidgetEvent(param1);
      }
