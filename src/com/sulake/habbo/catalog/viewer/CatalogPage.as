package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1128:EventDispatcher;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1382 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1382) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1128;
            _loc2_.init();
         }
         var_1128.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1128.dispatchEvent(param1);
      }
