package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2284:BitmapData;
      
      protected var var_950:Boolean;
      ...
      protected var var_454:int = 0;
      
      protected var var_1394:String;
      
      private const const_1635:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_375:BitmapData;
      
      private const const_1427:Number = 0.2;
      
      protected var var_1392:Boolean;
      
      private const const_1428:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_708)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1552));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1394);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1392 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2284;
               _loc5_.visible = true;
            }
            else
            {
