package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_965:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_555 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_555.width;
         var_89 = var_555.height;
         var_966 = param5;
         var_784 = param6;
         var_214 = Math.floor(var_966 / _thumbWidth);
         var_17 = new BitmapData(var_966,var_784);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_17.height < var_784)
         {
            _loc12_ = new BitmapData(var_17.width,var_784);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_555.width,var_555.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_555.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_555,var_555.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_965 != null)
         {
            _loc1_ = var_965.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_17 = new BitmapData(Math.max(var_214 * _thumbWidth,var_966),Math.max(var_464 * var_89,var_784),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_214 && var_17.height < _loc3_.y * var_89)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_214 - 1),var_89);
         _loc2_.copyPixels(var_17,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_214 - 1),0,_thumbWidth,var_17.height);
         _loc2_.copyPixels(var_17,_loc4_,new Point(0,var_89),null,null,true);
         _loc4_ = new Rectangle(0,var_89,_thumbWidth * (var_214 - 1),0 - var_89);
