package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1659:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_449,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_107:
               var_846 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_449:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_44.getValue(InventoryCategory.const_598));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_44.getValue(InventoryCategory.const_75));
      }
      ...
      {
         return PetsModel(var_44.getValue(InventoryCategory.const_140));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1659);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_44.getValue(InventoryCategory.const_317));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_845.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_845.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_44.getValue(InventorySubCategory.const_273));
      }
      ...
      {
         return var_44.getValue(InventoryCategory.const_308) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1017 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_44.getValue(InventoryCategory.const_236));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_449,roomSessionEventHandler);
         ...
         var_44.add(InventoryCategory.const_308,_loc3_);
         ...
         var_44.add(InventoryCategory.const_140,_loc10_);
