package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_522 = new Timer(const_1116,1);
         var_522.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_47.getSubCategoryViewId() == InventorySubCategory.const_273;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_439.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_439.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_708)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_522 != null)
            {
               var_522.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_522.stop();
               var_522 = null;
            }
            if(var_134 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_288)
         {
         ...
         if(var_750 == null)
         {
            var_750 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_750.clone() as IWindowContainer;
      ...
      {
         var_47.checkCategoryInitilization(InventoryCategory.const_308);
         ...
         if(param1 == InventoryCategory.const_75 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_312:
                  var_47.toggleInventoryPage(InventoryCategory.const_140);
            }
         }
      }
      ...
      {
         if(var_916 && param1.type == RoomEngineObjectEvent.const_218)
         {
            var_47.showView();
            var_916 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_293 || _loc3_.category == FurniCategory.const_288 || _loc3_.category == FurniCategory.const_326)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_439.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_439 = new Map();
         var_439.add(const_44,new Array());
         var_439.add(const_45,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
