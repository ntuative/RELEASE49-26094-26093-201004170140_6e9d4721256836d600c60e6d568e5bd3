package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_502:String = "room";
      
      private static const const_791:int = -2;
      
      private static const const_501:String = "temporary_room";
      ...
      private var var_757:RoomMessageHandler = null;
      
      private var var_756:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         var_757 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_65 != null)
         {
            ...
            {
               return var_65.deleteWallItem(var_114,var_113,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_313.length; _loc2_++)
         {
            _loc3_ = var_313.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_632) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_605) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_657) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_529) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_31)
            {
               return var_65.modifyWallItemData(var_114,var_113,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_756 != null)
         {
            var_756.release(new IIDRoomRendererFactory());
            var_756 = null;
         }
         ...
         if(var_313 != null)
         {
            ...
            {
               _loc2_ = var_313.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_756.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_920;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_564);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_596);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_727);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_943);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_980);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_829) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_950);
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_625,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_533,var_114,var_113,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            return var_65.modifyRoomObject(var_114,var_113,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_312.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_312.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_661,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_513,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_40 != null)
         {
            ...
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_37);
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_67);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_65 != null)
         {
            var_65.handleRoomObjectEvent(param1,var_114,var_113);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_333,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_889,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1026,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1028,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_264,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
      ...
      {
         if(var_26 == null || var_418 == null || var_40 == null || var_756 == null || _communication == null || _habboConfiguration == null || !var_2199)
         {
            return;
         }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1152,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_40.getRoom(getRoomIdentifier(var_114,var_113));
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1335);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1335);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_11 != null)
         {
            var_11.visualizationFactory = var_418;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_26 != null)
         {
            if(false)
            {
               var_26.events.addEventListener(RoomObjectMouseEvent.const_206,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_478,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_270,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_618,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_120,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_98,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_384,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_359,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_462,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_66,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_473,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_440,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_237,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_401,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_355,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_833,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_470,roomObjectEventHandler);
               var_26.events.addEventListener(AvatarWalkWarpingWarningEvent.const_396,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_664) != 0)
         {
            return false;
         }
         if(var_65 != null)
         {
            return var_65.initializeRoomObjectInsert(var_114,var_113,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_524 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_677,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_312.length)
            {
               _loc3_ = var_312.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_264,param1,param2,param3,RoomObjectCategoryEnum.const_37));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_31:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_366);
                     break;
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_287);
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_333,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_920,1,true);
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_261.events.addEventListener(AdEvent.const_429,showRoomAd);
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_313.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_756 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_40.getRoom(const_501);
         if(_loc10_ == null)
         {
            _loc10_ = var_40.createRoom(const_501,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_31:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_366,param8);
               break;
            case RoomObjectCategoryEnum.const_37:
            ...
            case RoomObjectCategoryEnum.const_67:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_151,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_729,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_510,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_581,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
         ...
         {
            var_1082.add(String(_loc11_),param5);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_791,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1575 - _loc12_.width / 2;
               _loc11_.y = var_1576 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_372,var_114,var_113,-1,RoomObjectCategoryEnum.const_208));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_65 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_281,const_502);
                  var_65.handleRoomObjectEvent(_loc14_,var_114,var_113);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1335);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1575 - _loc6_.data.width / 2;
               _loc11_.y = var_1576 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_327,param1.image,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_917,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_845,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_870,RoomObjectVariableEnum.const_327,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_313.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_313.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_65 != null)
         {
            var_65.cancelRoomObjectInsert(var_114,var_113);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_40.getRoom(const_501);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               _loc13_ = var_1082.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_114,var_113,const_281,RoomObjectCategoryEnum.const_67,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_805,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_664,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_828,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_281,const_502,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_664,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_564,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_632,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_657,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_605,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_529,_loc19_);
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_661,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_513,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_399,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_217);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        ...
                        _loc7_.setNumber(RoomObjectVariableEnum.const_943,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_980,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_791,const_1120,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
