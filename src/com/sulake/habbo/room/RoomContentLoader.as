package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_764:String = "selection_arrow";
      
      private static const const_763:String = "tile_cursor";
      ...
      private static const const_1073:String = const_348;
      
      private static const const_1418:int = 0;
      
      private static const const_765:int = 1;
      ...
      private var var_1001:IEventDispatcher = null;
      
      private var var_1209:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_483 = [];
         var_484 = [];
         var_1831 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1833 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_405 = new Map();
         _events = new Map();
      ...
      {
         if(var_167 != null && var_167.hasWorldType(const_278 + param1))
         {
            return var_167.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_483.indexOf(_loc14_) < 0)
                              {
                                 var_483.push(_loc14_);
                              }
                           }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_577.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_348,const_489,ROOM_CONTENT,const_763,const_764];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1831.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_181 && _loc5_ != RoomObjectLogicEnum.const_124)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_576.getValue(param1) != null)
         {
            return var_576.getValue(param1);
         }
         return "";
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1832)
         {
            ...
            if(var_1001 != null)
            {
               var_1001.dispatchEvent(new Event(const_540));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_167 != null)
         {
            return var_167.getWorldHeightScale(const_278 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_35,furniDataLoadedHandler);
            _loc5_.addEventListener(AssetLoaderEvent.const_46,furniDataLoadedHandler);
            var_1001 = param1;
            var_1828 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1827 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1829 = param2.getKey("public.room.dynamic.download.url","");
            var_1830 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_32 = const_765;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_181 && _loc5_ != RoomObjectVisualizationEnum.const_124)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_278 + param1) == RoomObjectCategoryEnum.const_67)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1209.getValue(param1) != null)
         {
            var_167 = var_1209.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_167 != null)
         {
            return var_167.getWorldScale(const_278 + param1);
         }
         return 32;
      }
