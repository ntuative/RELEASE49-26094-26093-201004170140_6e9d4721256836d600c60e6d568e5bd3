package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_518:BitmapDataAsset;
      ...
      {
         var_739 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc9_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_678);
         var _loc10_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_568);
         ...
         var _loc13_:int = param2 - var_1320;
         ...
         var _loc15_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_339);
         if(_loc15_ > 0)
         {
         ...
         var _loc16_:Boolean = var_285 != _loc3_.getUpdateID() || var_208 != param1.scale || var_159 != _loc4_.getUpdateID();
         var _loc17_:Boolean = var_412 || var_517 > 0;
         if(_loc16_ || _loc17_)
         {
            increaseUpdateId();
            --var_517;
            ...
            if(var_295 != _loc7_)
            {
               for each(_loc40_ in var_361.getKeys())
               {
                  _loc41_ = var_361.getValue(_loc40_) as IAvatarImage;
                  if(_loc41_)
                  {
                     _loc41_.dispose();
                  }
                  var_361.remove(_loc40_);
               }
               if(_loc6_)
               {
                  _loc6_.dispose();
            ...
            if(_loc6_ == null)
            {
               _loc42_ = _loc4_.getString(RoomObjectVariableEnum.const_994);
               _loc6_ = var_739.getAvatar(_loc7_,param1.scale,_loc42_);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc21_ = _loc4_.getNumber(RoomObjectVariableEnum.const_287);
            if(isNaN(_loc21_) || _loc4_.getString(RoomObjectVariableEnum.const_255) == "float")
            {
               _loc21_ = _loc20_;
            }
            else
            ...
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_255);
            _loc23_ = _loc4_.getString(RoomObjectVariableEnum.const_591);
            _loc6_.appendAction(AvatarAction.const_539,_loc22_,_loc23_);
            _loc24_ = false;
            if(_loc22_ == "lay")
            {
               _loc43_ = int(_loc23_);
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_362);
            if(_loc25_ > 0 && _loc6_.getScale() == AvatarScaleType.const_55)
            {
               _loc44_ = _loc4_.getNumber(RoomObjectVariableEnum.const_454);
               _loc45_ = 3;
               _loc46_ = param2 - _loc44_;
               if(_loc46_ < _loc45_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_309,AvatarAction.const_1143[_loc25_]);
               }
            }
            _loc26_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1022);
            if(_loc26_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_816,_loc26_);
            }
            _loc27_ = _loc4_.getNumber(RoomObjectVariableEnum.const_924);
            if(_loc27_ > 0)
            {
               _loc47_ = _loc4_.getNumber(RoomObjectVariableEnum.const_979);
               _loc48_ = 5;
            ...
            _loc28_ = _loc4_.getNumber(RoomObjectVariableEnum.const_520);
            _loc29_ = 0;
            if(_loc28_ > 0)
            {
               _loc50_ = _loc4_.getNumber(RoomObjectVariableEnum.const_563);
               _loc51_ = 100;
               _loc52_ = param2 - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_1013,_loc28_);
                  _loc53_ = 1;
                  while(_loc53_ < 10)
                  {
            ...
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_832);
            if(_loc29_ > 0)
            {
               _loc30_ = _loc29_;
            }
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_1024,_loc30_);
            }
            if(_loc8_)
            {
               _loc6_.appendAction(AvatarAction.const_356);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_415) > 0;
            if(_loc31_ || _loc12_)
            {
            ...
            if(_loc14_)
            {
               _loc6_.appendAction(AvatarAction.const_365);
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_814);
            if(_loc32_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_696,_loc32_);
            }
            ...
            if(_loc22_ == "mv" || _loc22_ == "std")
            {
               ...
               if(var_516 != null)
               {
                  _loc35_.asset = var_516.content as BitmapData;
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_831))
            {
               ...
               {
                  case 32:
                     var_518 = var_739.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
                     _loc67_ = 3;
                     _loc68_ = -42;
                     break;
                  case 64:
                     var_518 = var_739.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
                     _loc67_ = 14;
                     _loc68_ = -83;
               }
               if(var_518 != null)
               {
                  _loc35_.asset = var_518.content as BitmapData;
            ...
            var_861.push(getTimer() - _loc19_);
            if(false)
            {
               _loc69_ = 0;
               _loc70_ = "[";
               for each(_loc71_ in var_861)
               {
                  _loc69_ += _loc71_;
                  _loc70_ += "," + _loc71_;
               }
