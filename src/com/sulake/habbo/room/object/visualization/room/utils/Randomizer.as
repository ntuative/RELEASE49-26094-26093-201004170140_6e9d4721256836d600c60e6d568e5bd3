package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1453:int = 16777216;
      
      public static const const_1482:int = 1;
       
      
      private var var_2359:int = 69069;
      
      private var var_1253:int = 1;
      
      private var var_2358:int = 5;
      
      private var var_1514:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1514 * param2);
      }
      ...
      {
         var _loc1_:int = var_2359 * var_1253 + var_2358;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
