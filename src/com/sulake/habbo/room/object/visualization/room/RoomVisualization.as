package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1190:int = 13421772;
      
      private static const const_771:int = 16777215;
      
      public static const const_1401:int = 10066329;
      
      private static const const_772:int = 13421772;
      
      public static const const_1333:int = 16777215;
      
      private static const const_1425:int = 0;
      
      public static const const_1156:int = 16777215;
      ...
      private var var_589:Rectangle = null;
      ...
      private var var_1935:String = null;
      
      private const const_1658:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_846);
         ...
         while(_loc7_ < var_76.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1303)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_221,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < var_98.length)
            {
               _loc4_ = var_98[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            _loc3_ = var_98[_loc2_] as RoomPlane;
            _loc4_ = getSprite(_loc2_);
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               if(_loc3_.type == RoomPlane.const_221 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_589 == null)
         {
            var_589 = super.boundingRectangle;
         }
         return new Rectangle(var_589.x,var_589.y,var_589.width,var_589.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var_414.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:int = 0;
         while(_loc4_ < var_98.length)
         {
            _loc3_ = var_98[_loc4_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_414.maskCount)
         {
            _loc6_ = var_414.getMaskType(_loc5_);
            _loc7_ = var_414.getMaskLocation(_loc5_);
            _loc8_ = var_414.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_98.length)
               {
                  _loc3_ = var_98[_loc9_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_221 || _loc3_.type == RoomPlane.const_191 && _loc8_ == RoomPlaneBitmapMaskData.const_217)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1508;
                        if(var_76.getPlaneType(_loc9_) == RoomPlaneData.const_151)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1211)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1002 || _loc9_.y != var_1837 || _loc9_.z != var_1836 || param1.scale != var_1840))
            {
               var_1002 = _loc9_.x;
               var_1837 = _loc9_.y;
               var_1836 = _loc9_.z;
               var_1840 = param1.scale;
               _loc4_ = true;
            }
         }
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_885);
            if(_loc10_ != var_1935)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_656));
            if(_loc11_ != var_1013)
            {
               var_1013 = _loc11_;
               var_1932 = var_1013 & 255;
               var_1933 = var_1013 >> 8 & 255;
               var_1938 = var_1013 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1937 + const_1658 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1937 = _loc7_;
         if(var_159 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_510);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_729);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_581);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1936 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_841));
            var_159 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_415.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_415[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_191)
            {
               if(var_1936)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1932 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1933 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1938 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_98.length)
         {
            _loc5_ = var_98[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_221 && param2 != null)
               {
                  _loc5_.id = param2;
               }
