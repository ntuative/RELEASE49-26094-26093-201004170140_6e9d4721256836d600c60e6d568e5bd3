package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_720:PlaneVisualization = null;
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = var_306.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_720 = var_306.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_720 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_306 != null)
         {
            ...
            {
               _loc1_ = var_306.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
