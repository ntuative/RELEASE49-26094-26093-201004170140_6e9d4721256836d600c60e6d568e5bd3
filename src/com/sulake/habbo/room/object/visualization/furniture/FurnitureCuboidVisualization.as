   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < var_98.length)
         {
            ...
            _loc9_ = var_98[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_98 != null)
         {
            ...
            {
               _loc2_ = var_98[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_452);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_649);
