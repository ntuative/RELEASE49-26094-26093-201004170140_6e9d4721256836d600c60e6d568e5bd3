package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2290:Number = NaN;
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2293,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_2223 != param1 || var_2220 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_2222 != param1 || var_2221 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2293 = _loc3_.getNumber(RoomObjectVariableEnum.const_230);
            ...
            var_1487 = _loc3_.getString(RoomObjectVariableEnum.const_333);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_285 != _loc3_.getUpdateID() || param1 != var_208 || param2 != var_2290)
         {
