package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_783:int = 15;
      
      private static const const_1107:int = 2;
      
      private static const const_346:int = 2;
      
      private static const const_782:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1054[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1053[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1054 = new Array();
         var_1054.push(Math.random() * _loc2_ * 1.5);
         var_1054.push(Math.random() * _loc2_ * 1.5);
         var_1056 = new Array();
         var_1056.push(1);
         var_1056.push(-1);
         var_1055 = new Array();
         var_1055.push(const_1107);
         var_1055.push(const_1106);
         var_1053 = new Array();
         var_1053.push(getRandomAmplitudeFactor());
         var_1053.push(getRandomAmplitudeFactor());
      }
