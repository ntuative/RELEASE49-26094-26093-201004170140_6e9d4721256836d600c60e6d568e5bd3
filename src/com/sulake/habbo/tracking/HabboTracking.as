package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_809:LagWarningLogger = null;
      
      private var var_810:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_809 = new LagWarningLogger();
         var_1176 = new Array(const_757);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1176,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1227,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_640,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_922,String(0));
         }
      ...
      private function method_9(param1:RoomObjectRoomAdEvent) : void
      {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_557:
               trackLoginStep(HabboLoginTrackingStep.const_1258,String(_communication.port));
               break;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_148)
         {
            Component(var_148).events.addEventListener(HabboConfigurationEvent.const_154,onConfigurationLoaded);
            if(var_220 != null)
            {
               var_220.configuration = var_148;
            }
            if(var_219 != null)
            {
               var_219.configuration = var_148;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_261.events.addEventListener(AdEvent.const_429,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1793)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1346);
            var_1793 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_922,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_640,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_427,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_396:
               var_809.warpingDetected();
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_810)
            {
               var_810.release(new IIDHabboWindowManager());
               var_810 = null;
            }
            if(var_261)
            {
            ...
            if(var_165)
            {
               if(true)
               {
                  ...
                  Component(var_165).events.removeEventListener(HabboFriendListTrackingEvent.const_310,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_396,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_148)
         {
            if(var_809 != null)
            {
               var_809.configure(var_148);
            }
            Component(var_148).events.removeEventListener(HabboConfigurationEvent.const_154,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_957);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_957,onCoreRunning);
         }
      }
      ...
      {
         var_810 = IHabboWindowManager(param2);
         if(var_810)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_985 > -1 && _loc2_ < var_985)
         {
            ++var_1456;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1456);
         }
         if(var_985 > -1 && _loc2_ - var_985 > 15000)
         {
            ++var_1455;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1455);
         }
         var_985 = _loc2_;
         if(var_219 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_396,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_237,method_9);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_165).events.addEventListener(HabboFriendListTrackingEvent.const_310,onFriendlistTrackingEvent);
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            trackLoginStep(HabboLoginTrackingStep.const_1200);
         }
         else if(param1.type == HabboHotelViewEvent.const_427)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1260);
         }
         else if(param1.type == HabboHotelViewEvent.const_65)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1217);
         }
      }
   }
}
