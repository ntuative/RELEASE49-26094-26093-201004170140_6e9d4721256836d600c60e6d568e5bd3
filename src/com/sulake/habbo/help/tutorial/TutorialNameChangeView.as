package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private var var_283:IBorderWindow;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_336);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_336);
         }
         if(var_283 == null)
         {
            var_283 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_283 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_283);
            var_283.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_283.visible = param1;
      }
