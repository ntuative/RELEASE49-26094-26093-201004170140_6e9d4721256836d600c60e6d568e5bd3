package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2023:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26094-26093-201004170047");
         var_193 = param5;
         var_101 = new Map();
         var_101.add(HabboHelpViewEnum.const_1319,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_149,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_412,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_256,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_215,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_704,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_323,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_700,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_226,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_101.add(HabboHelpViewEnum.const_987,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_643,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_268 == HabboHelpViewEnum.const_149 || false)
         {
            return;
         }
         if(var_421 == null)
         {
            ...
            var_421 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_421 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_421 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_421 as IWindow);
      ...
      {
         return var_101.getValue(var_268);
      }
      ...
      {
         var_2024 = param1;
         var _loc2_:IHelpViewController = var_101.getValue(HabboHelpViewEnum.const_149) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_226:
               ...
               break;
            case CallForHelpResultEnum.const_964:
      ...
      {
         var _loc3_:* = null;
         if(var_268 == HabboHelpViewEnum.const_149)
         {
            return;
         }
         if(true)
         ...
         var _loc2_:IBitmapWrapperWindow = var_421.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.width = _loc1_.width + var_1534;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_193 != null)
            {
               var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_21.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_428));
      }
