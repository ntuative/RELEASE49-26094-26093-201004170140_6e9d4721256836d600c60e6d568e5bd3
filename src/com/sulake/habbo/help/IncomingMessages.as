package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboHelp, param2:IHabboCommunicationManager)
      {
         ...
         _loc3_.addHabboConnectionMessageEvent(new UsersMessageEvent(method_11));
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_21.tellUI(HabboHelpViewEnum.const_215,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_256,_loc6_);
      }
      ...
      {
         var_21.showUI(HabboHelpViewEnum.const_323);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_21.showUI(HabboHelpViewEnum.const_412);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_21.showUI(HabboHelpViewEnum.const_704);
         var_21.tellUI(HabboHelpViewEnum.const_704,_loc5_);
      }
      ...
      private function method_11(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_325)
            {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_643);
      }
