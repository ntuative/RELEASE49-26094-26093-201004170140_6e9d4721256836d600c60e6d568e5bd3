package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private function prepareCore() : void
      {
         ...
         _loc1_.addEventListener(AssetLoaderEvent.const_46,configLoadedHandler);
      }
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            var_27.error("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",true,Core.const_802);
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_864,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            trackLoginStep(Habbo.const_27);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_864,error);
            Core.dispose();
         }
      }
